...
API_OVERRIDES = APIOverrides(
    ...
    search_api_endpoint_override=os.getenv("SEARCH_API", "https://search-api.dev.rrap-is.com"),
...
class SecureTokenManager:
    """Handles secure storage of authentication tokens using system keyring"""
    
    def __init__(self):
        self.service_name = "provena-mcp-server"
        self.username = "tokens"
    ...
    def load_tokens(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            json_data = keyring.get_password(self.service_name, self.username)
            if not json_data:
                return None
